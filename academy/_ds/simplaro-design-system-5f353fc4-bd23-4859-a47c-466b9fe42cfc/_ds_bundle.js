...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    value: tweaks.sealShow,
    onChange: v => setTweak('sealShow', v)
  }), /*#__PURE__*/React.createElement(TweakSlider, {
    label: "Position X",
    value: tweaks.sealX,
    min: 10,
    ...
    step: 1,
    unit: "vh",
    onChange: v => setTweak('sealY', v)
  }), /*#__PURE__*/React.createElement(TweakSlider, {
    label: "Gr\xF6sse",
    value: tweaks.sealSize,
    min: 100,
    max: 260,
    step: 5,
    unit: "px",
    onChange: v => setTweak('sealSize', v)
  }), /*#__PURE__*/React.createElement(TweakSlider, {
    label: "Drehung",
    value: tweaks.sealRotate,
    min: -15,
    max: 15,
    step: 1,
    unit: "\xB0",
    onChange: v => setTweak('sealRotate', v)
  }), /*#__PURE__*/React.createElement(TweakSection, {
    label: "Hero-Extras"
  }), /*#__PURE__*/React.createElement(TweakToggle, {
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "\u2713"), /*#__PURE__*/React.createElement("span", null, "MASSGESCHNEIDERT AUF IHRE ZIELE")), t.stampTail ? /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      position: 'absolute',
      left: `${t.stampTailX}%`,
  ...
  }) : null), t.sealShow ? /*#__PURE__*/React.createElement("div", {
    className: "hero-stamp",
    style: {
      position: 'absolute',
      zIndex: 34,
      ...
      width: t.sealSize,
      height: t.sealSize,
      transform: `translateX(-50%) rotate(${t.sealRotate}deg)`
    }
    ...
    style: {
      ...
      height: '100%',
      display: 'block',
      filter: 'drop-shadow(0 10px 26px rgba(62,22,6,0.35))'
    },
    role: "img",
    "aria-label": "DSGVO-konform \u2014 Schweizer DSG und EU-DSGVO"
    ...
    startOffset: "50%",
    textAnchor: "middle"
  }, "DSGVO-KONFORM")), /*#__PURE__*/React.createElement("text", {
    fontFamily: "Quicksand, sans-serif",
    fontSize: "12.5",
    fontWeight: "700",
    letterSpacing: "2",
    ...
    startOffset: "50%",
    textAnchor: "middle"
  }, "SCHWEIZER DSG \xB7 EU-DSGVO")), /*#__PURE__*/React.createElement("text", {
    x: "100",
    y: "88",
    textAnchor: "middle",
    fontFamily: "Quicksand, sans-serif",
    ...
    letterSpacing: "2.2",
    fill: "#1C1613"
  }, "SIMPLARO"), /*#__PURE__*/React.createElement("text", {
    x: "100",
    y: "132",
    textAnchor: "middle",
    ...
    letterSpacing: "1.5",
    fill: "#8C8178"
  }, "Z\xDCRICH \xB7 CH"), /*#__PURE__*/React.createElement("text", {
    x: "100",
    y: "150",
    textAnchor: "middle",
    fontFamily: "Quicksand, sans-serif",
...
function UeberUns() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    name: "Philip Krieger",
    role: "Mitgr\xFCnder \xB7 AI Trainer & Coach"
